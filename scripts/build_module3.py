...
def build_practice3() -> None:
    ...
    body = """
      ...
      <h2>Downloads</h2>
      <p>
        <a class="download-link" href="files/practice_project3_starter.py" download>
          &#x1F4E5; Download starter script (practice_project3_starter.py)
        </a>
      </p>
      <p>
        <a class="download-link" href="files/practice_project3_promptbook.md" download>
          &#x1F4E5; Download prompt book (practice_project3_promptbook.md)
        </a>
      </p>"""
